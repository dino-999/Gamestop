<%-- 
    Document   : editgame
    Created on : 06-Sep-2021, 21:19:54
    Author     : Dino
--%>
    ...
    <body>
        ...
        <div class=" container">
            <div class="row">
                <div class="col-12">
                    <h3>
                        Edit Game Details</h3>
                    <form action="edit-game-servlet?id=<%= g.getId()%>" method="post">
                        <div class="form-group">
                            <label>Game Name</label>
                            <input class="form-control" name="name" value="<%=g.getName()%>" required>
                        </div>
                        <div class="form-group">
                            <label>Game Price</label>
                            <input class="form-control" name="price" value="<%=g.getPrice()%>" required>
                        </div>
                        <div class="form-group" >
